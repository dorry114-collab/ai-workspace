...

{
  ...
  "summary": "영상에서 화자가 언급한 구체적인 데이터(수치, 통계), 고유 명사, 전문 용어, 구체적 사례들을 하나도 빠짐없이 포함하여, 마치 한 편의 상세한 블로그 리뷰나 전문 기사를 읽는 것처럼 정보량이 극도로 풍부하고 깊이 있게 작성한 상세 요약 본문 (최소 5~7개의 긴 문단 분량으로 아주 자세하게 작성할 것)",
  "suggested_questions": [
