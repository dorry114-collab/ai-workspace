...

{
  ...
  "core_summary": "이 영상을 안 본 사람도 단숨에 뼈대를 이해할 수 있는 '초핵심 단기 요약' (정확히 5문장으로 작성할 것)",
  "timeline_summary": [
    { "time": "12:34", "sec": 754, "title": "구간 핵심 주제", "desc": "해당 구간 짧은 요약 (4~5개 구간 도출할 것)" }
  ],
  "summary": "영상 핵심 내용을 3~4문단으로 깔끔하고 한눈에 들어오게 요약한 본문 (상세 내용)",
  "suggested_questions": [
    "시청자가 영상 내용에 대해 AI에게 추가로 물어볼 만한 흥미로운 질문 예시 1",
    "질문 예시 2",
    "질문 예시 3"
  ],
  "glossary": [
